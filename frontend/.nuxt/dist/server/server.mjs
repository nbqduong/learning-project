import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, h, resolveComponent, computed, unref, provide, ref, Suspense, Fragment, mergeProps, withCtx, createTextVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/app/node_modules/h3/dist/index.mjs";
...
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/app/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BUSx0L_F.js")
  },
  {
    name: "auth-login",
    path: "/auth/login",
    component: () => import("./_nuxt/login-DUwqxw-O.js")
  },
  {
    name: "auth-register",
    path: "/auth/register",
    component: () => import("./_nuxt/register-CCKfyn55.js")
  },
  {
    name: "courses",
    path: "/courses",
    component: () => import("./_nuxt/index-BlCVMnjq.js")
  },
  {
    name: "courses-slug",
    path: "/courses/:slug()",
    component: () => import("./_nuxt/_slug_-BRDQMdmq.js")
  },
  {
    name: "me-enrollments",
    path: "/me/enrollments",
    component: () => import("./_nuxt/enrollments-BYvf9zI_.js")
  },
  {
    name: "instructor",
    path: "/instructor",
    component: () => import("./_nuxt/index-BqtwSSEu.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-7CCUPrv8.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Uorvvchd.js"));
