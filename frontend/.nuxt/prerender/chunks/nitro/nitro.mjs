...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///app/node_modules/ufo/dist/index.mjs';
...
import { dirname, resolve } from 'file:///app/node_modules/pathe/dist/index.mjs';
...
storage.mount('internal:nuxt:prerender', _47app_47node_modules_47_64nuxt_47nitro_45server_47dist_47runtime_47utils_47cache_45driver_46js({"driver":"/app/node_modules/@nuxt/nitro-server/dist/runtime/utils/cache-driver.js","base":"/app/.nuxt/cache/nitro/prerender"}));
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e8b948f3-4ab7-420c-92eb-11c4f67d4a65",
  ...
  "apiInternalBaseUrl": "http://backend:8080"
};
const envOptions = {
  prefix: "NITRO_",
...
const _lazy_0XwxzV = () => import('../_/renderer.mjs').then(function (n) { return n.r; });
